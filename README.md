# Groceries Supermarket Web Application - JavaScript Implementation

## Description

This project is the second part of an individual assignment for the **COMP40004 Web Development and Operating Systems** module at **Asia Pacific Institute of Information Technology (APIIT), Sri Lanka (Partnered with Staffordshire University UK)**. 
This phase of the project focuses on implementing a client-side web application for Groceries Supermarket, integrating JavaScript to enhance functionality and user experience.
...
6. [Order Page](Order_Page.html)
7. [Payment Page](Payment_Page.html)
8. [Loyalty Registration Page](Loyalty_Registration.html)
